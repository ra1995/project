...
int main()
{
	...
	Mat frame,mask,palm_mask,img,depth_map,depth_range;
	...
	while(true)
	{
		...
		frame=Mat(480,640,CV_8UC3,(uchar*)data_rgb.planes[0],640*3*sizeof(uchar));
		depth_map=Mat(240,320,CV_16U,(uchar*)data_depth.planes[0]);
		inRange(depth_map,Scalar(0),Scalar(500),depth_range);
